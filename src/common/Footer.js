            ...
            <div className="row">
                ...
                <div className="col-md-4">
                    ...
                    <ul className="pl-0 mb-0 d-flex flex-wrap align-items-center social justify-content-center justify-content-md-start">
                        <li><a href="#" className="d-block p-2 pl-md-0"><i className="fa fa-facebook-square" aria-hidden="true"></i></a> </li>
                        <li><a href="#" className="d-block p-2"><i className="fa fa-twitter-square" aria-hidden="true"></i></a> </li>
                        <li><a href="#" className="d-block p-2"><i className="fa fa-linkedin-square" aria-hidden="true"></i></a> </li>
                        <li><a href="#" className="d-block p-2"><i className="fa fa-youtube-play" aria-hidden="true"></i></a> </li>
                        <li><a href="#" className="d-block p-2"><i className="fa fa-instagram" aria-hidden="true"></i></a> </li>
                    </ul>
                </div>
